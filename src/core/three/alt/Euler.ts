...
export class Euler {
	...
	static readonly DEFAULT_ORDER: EulerOrder = 'XYZ' as const
	...
	fromArray(array: [number, number, number, EulerOrder]) {
		this._x = array[0]
		this._y = array[1]
		this._z = array[2]
	...
	toArray(array = [] as any as [number, number, number, EulerOrder], offset = 0) {
