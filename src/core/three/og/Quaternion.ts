...
export class Quaternion {
	...
	setFromUnitVectors(
		vFrom: { dot: (arg0: any) => number; x: number; z: number; y: number },
		vTo: { z: number; y: number; x: number },
	) {
	...
	dot(v: { _x: number; _y: number; _z: number; _w: number }) {
	...
	/**
	 * from {@link http://www.euclideanspace.com/maths/algebra/realNormedAlgebra/quaternions/code/index.htm}
	 */
	...
	/**
	 * @see {@link http://www.euclideanspace.com/maths/algebra/realNormedAlgebra/quaternions/slerp/}
	 */
	...
	slerpQuaternions(qa: any, qb: any, t: any) {
	...
	equals(quaternion: { _x: number; _y: number; _z: number; _w: number }) {
		return (
	...
	toArray(
		array = [] as unknown as [number, number, number, number],
		offset = 0,
