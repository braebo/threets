...
export class Matrix3 {
	...
	makeTranslation(x: Vector2, y: Vector2): this
	makeTranslation(x: number | Vector2, y: number | Vector2): this {
		if ((x as Vector2).isVector2) {
			// prettier-ignore
			this.set(
				1, 0, (x as Vector2).x,
				0, 1, (x as Vector2).y,
	...
	toArray(array = [] as any as Mat3, offset = 0): Mat3 {
		const te = this.elements
